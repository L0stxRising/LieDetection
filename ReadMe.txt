...
## Quick start
1. Clone: `git clone https://github.com/<your-username>/ReLie-Toolkit.git`  
2. Install deps: `pip install -r requirements.txt`  
3. Run lie demo: `python lie_demo.py`  
4. Run scanner: `python port_scanner.py --host 192.168.1.1 --ports 1-1024`
